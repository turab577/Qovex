...
export default function About() {
  return (
    <div>
      <div className='  sm:pt-20 flex flex-col sm:flex-row sm:justify-around'>
        <p className=' text-[25px] lg:text-[40px] text-black text-center'>About Qovex</p>
        <div className='text-center pl-[31px] pr-[35px] sm:pl-0 sm:pr-0 sm:text-start'>
      ...
      <div className=' pt-0 sm:pt-10 w-[100%]'>
      <AnChart/>
      </div>
    </div>
  )
